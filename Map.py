...
class Map:
    def __init__(self, soup):
        ...
        self.type_nodes = self.map_tag['height'] # y pointss
        ...
        self.type_array = np.zeros((self.x_size, self.z_size)) #matrix of y values. Indexes are X and Y values

        print("Map x value is: " + str(self.x_size))
        print("Map z value is: " + str(self.z_size))
        print("Map is loading... This may take some time.")
